          ...
          <div className="container-max">
            <div className="max-w-3xl">
              ...
              <p className="text-muted-foreground text-lg leading-relaxed">
                Stay up to date with the latest trends in technology, digital
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2">
                  ...
                  <div className="p-8 md:p-10 flex flex-col justify-center">
                    <span className="text-xs font-medium text-accent bg-accent/10 px-3 py-1 rounded-full w-fit mb-4">
                      Featured
                    </span>
                    ...
                    <div className="text-sm text-muted-foreground">
                      {featured[0].date} · {featured[0].readTime} read
                    </div>
                  </div>
                </div>
              </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {paginated.map((post, i) => (
                <AnimatedSection key={post.id} delay={i * 80}>
                  <Link
                    href={`/blog/${post.slug}`}
                    className="block group rounded-2xl overflow-hidden bg-card border border-border hover-lift h-full"
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-heading font-semibold mt-2 mb-2 group-hover:text-primary transition-colors line-clamp-2">
                        {post.title}
                      </h3>
