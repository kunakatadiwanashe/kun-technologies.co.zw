import { Service, BlogPost, Project, Testimonial } from "./types";

export const services: Service[] = [
  {
    id: "1",
    title: "Web Development",
    description: "We build high-performance, scalable web applications using cutting-edge technologies. From corporate websites to complex web platforms, we deliver solutions that drive business growth.",
    icon: "Globe",
    benefits: ["Lightning-fast performance", "SEO-optimized architecture", "Scalable & maintainable code", "Responsive across all devices"],
  ...
  },
  {
    ...
    description: "Launch your online store with our custom e-commerce solutions. We create seamless shopping experiences that convert visitors into customers and maximize your revenue.",
    icon: "ShoppingCart",
    benefits: ["Secure payment integration", "Inventory management", "Mobile-first design", "Analytics & reporting"],
  ...
  },
  {
    id: "3",
    title: "UI/UX Design",
    description: "Create intuitive, beautiful digital experiences. Our design process centers on understanding your users to deliver interfaces that delight and convert.",
    icon: "Palette",
    benefits: ["User research & testing", "Wireframing & prototyping", "Design systems", "Accessibility compliance"],
  ...
  },
  {
    ...
    description: "Build a memorable brand identity that resonates with your audience. From logos to complete brand guidelines, we craft visual stories that set you apart.",
    icon: "Brush",
    benefits: ["Logo design & brand identity", "Marketing collateral", "Social media graphics", "Print & digital assets"],
  ...
  },
  {
    ...
    description: "Keep your technology running smoothly. We provide comprehensive IT support, computer repairs, networking solutions, and technical consulting for businesses of all sizes.",
    icon: "Wrench",
    benefits: ["Quick turnaround times", "On-site & remote support", "Network setup & security", "Hardware & software solutions"],
    technologies: ["Windows", "macOS", "Linux", "Networking", "Cloud Services"],
    slug: "it-support",
  },
  {
    id: "6",
    title: "Photography & Media",
    description: "Professional photography and media production services to elevate your brand. We capture compelling visuals for products, events, corporate profiles, and marketing campaigns.",
    icon: "Camera",
    benefits: ["Product photography", "Event coverage", "Corporate headshots", "Video production"],
    technologies: ["Canon", "Adobe Lightroom", "Premiere Pro", "DaVinci Resolve"],
    slug: "photography",
  },
  {
    id: "7",
    title: "Custom Software",
    description: "Tailored software solutions designed specifically for your business needs. From ticketing systems to reward platforms, we build tools that streamline your operations.",
    icon: "Code",
    benefits: ["Bespoke business systems", "Admin dashboards", "API development", "System integration"],
...
<p>At KunTech, we specialize in building modern, fast, and SEO-optimized websites for Zimbabwean businesses. Our solutions are tailored to your industry and designed to generate real results. Contact us today to start your digital journey.</p>`,
    ...
    tags: ["Web Development", "Zimbabwe", "Business"],
  },
  {
    id: "2",
...
<p>At KunTech, we build e-commerce solutions that are tailored to the Zimbabwean market, with integrated mobile payment gateways, local delivery tracking, and social media integration. Let us help you tap into the growing digital economy.</p>`,
    ...
    tags: ["E-commerce", "Zimbabwe", "Mobile Payments"],
  },
  {
    id: "4",
...
<p>We partner with businesses at every stage of their digital journey. From building your first website to creating custom business systems, we provide the technology and expertise to drive your transformation.</p>`,
    ...
    tags: ["Digital Transformation", "Strategy", "Zimbabwe"],
  },
  {
    id: "6",
...
<p>This project demonstrates the power of custom software tailored to specific business needs. Contact KunTech to discuss how we can build solutions for your business.</p>`,
    ...
    tags: ["Case Study", "Custom Software", "Retail"],
  },
];
...
export const projects: Project[] = [
  {
    id: "1",
    title: "ZimTrade Online Marketplace",
    description: "A full-featured e-commerce platform connecting Zimbabwean artisans with global buyers, featuring mobile payment integration and real-time inventory management.",
    category: "E-commerce",
    image: "https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=800&q=80",
    technologies: ["Next.js", "Node.js", "MongoDB", "Stripe", "EcoCash"],
    slug: "zimtrade-marketplace",
    client: "ZimTrade",
    results: ["200% increase in online sales", "5,000+ registered sellers", "30-second average checkout time"],
  },
  {
    id: "2",
    title: "Harare Medical Portal",
    description: "A patient management and appointment booking system for a leading medical group, with telemedicine capabilities and electronic health records.",
    category: "Web App",
    image: "https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?w=800&q=80",
    technologies: ["React", "Node.js", "PostgreSQL", "WebRTC"],
    slug: "harare-medical-portal",
    client: "Harare Medical Group",
    results: ["50% reduction in no-shows", "1,000+ appointments booked monthly", "98% patient satisfaction"],
  },
  {
    id: "3",
    title: "Safari Lodge Brand Identity",
    description: "Complete brand redesign for a premium safari lodge, including logo, marketing materials, website, and social media presence.",
    category: "Branding",
    image: "https://images.unsplash.com/photo-1516426122078-c23e76319801?w=800&q=80",
    technologies: ["Adobe CC", "Figma", "Next.js", "Photography"],
    slug: "safari-lodge-brand",
    client: "Matobo Safari Lodge",
    results: ["300% increase in direct bookings", "Brand recognition up 150%", "Award-winning design"],
  },
  {
    id: "4",
    title: "Smart Ticketing System",
    description: "A custom event ticketing platform with QR code verification, real-time analytics, and multi-venue support for Zimbabwe's entertainment industry.",
    category: "Custom Software",
    image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&q=80",
    technologies: ["React", "Node.js", "Redis", "QR API"],
    slug: "smart-ticketing",
    client: "ZimEvents",
    results: ["Zero fraud incidents", "50,000+ tickets sold", "15-second average entry time"],
  },
  {
    id: "5",
    title: "Corporate Photography Suite",
    description: "Professional photography services for a financial institution, including corporate headshots, office interiors, and marketing campaign visuals.",
    category: "Photography",
    image: "https://images.unsplash.com/photo-1556761175-4b46a572b786?w=800&q=80",
    technologies: ["Canon R5", "Adobe Lightroom", "Capture One"],
    slug: "corporate-photography",
    client: "First Capital Bank",
    results: ["200+ professional photos delivered", "Used across 5 marketing campaigns", "Consistent brand imagery"],
  },
  {
    id: "6",
    title: "Fleet Management Dashboard",
    description: "A real-time fleet tracking and management system for a logistics company with GPS integration, driver management, and route optimization.",
    category: "Web App",
    image: "https://images.unsplash.com/photo-1558618666-fcd25c85f82e?w=800&q=80",
    technologies: ["React", "Python", "PostgreSQL", "Google Maps API"],
    slug: "fleet-management",
    client: "Swift Logistics",
    results: ["30% fuel cost reduction", "Real-time tracking of 100+ vehicles", "95% on-time delivery rate"],
  },
];
...
export const testimonials: Testimonial[] = [
  {
    ...
    role: "CEO",
    company: "ZimTrade",
    content: "KunTech transformed our business with a world-class e-commerce platform. Our online sales increased by 200% within the first six months. Their team is incredibly professional and technically skilled.",
    avatar: "TM",
  },
  {
    id: "2",
    ...
    company: "Matobo Safari Lodge",
    content: "The brand identity KunTech created for us perfectly captures the essence of our safari experience. We've seen a dramatic increase in direct bookings since the redesign. Outstanding work!",
    avatar: "SN",
  },
  {
    id: "3",
    ...
    content: "The fleet management system has been a game-changer. We cut fuel costs by 30% and our delivery times have never been better. KunTech understood our needs from day one.",
    avatar: "DC",
  },
  {
    id: "4",
    ...
    company: "Harare Medical Group",
    content: "Our patient management portal has streamlined everything. No-shows dropped by 50%, and patients love the convenience of online booking. KunTech delivered beyond our expectations.",
    avatar: "GM",
  },
];
